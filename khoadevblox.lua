...
if game:GetService('Players').LocalPlayer.PlayerGui.Main:FindFirstChild('ChooseTeam') then
    ...
    _ImageButton.BackgroundColor3 = Color3.fromRGB(80, 80, 80)
    _ImageButton.Position = UDim2.new(0.10615778, 0, 0.16217947, 0)
    _ImageButton.Size = UDim2.new(0.0627121851, 0, 0.107579626, 0)
    _ImageButton.Image = 'rbxassetid://18728311365'
    _UICorner.CornerRadius = UDim.new(0, 30)
    _UICorner.Parent = _ImageButton
    _UIAspectRatioConstraint.Parent = _ImageButton
    _UIAspectRatioConstraint.AspectRatio = 0.988

    local function v241()
        local _LocalScript = Instance.new('LocalScript', _UIGradient)
        local _TweenService3 = game:GetService('TweenService')
        local v240 = TweenInfo.new(4, Enum.EasingStyle.Linear, Enum.EasingDirection.In, -1)

        _TweenService3:Create(_LocalScript.Parent, v240, {Rotation = 360}):Play()
    end

    coroutine.wrap(v241)()

    local function v255()
        local _LocalScript2 = Instance.new('LocalScript', _ImageButton)
        local _UserInputService = game:GetService('UserInputService')
        local _Parent = _LocalScript2.Parent
        local u245 = nil
        local u246 = 0.25
        local u247 = nil
        local u248 = nil

        local function u252(p249)
            local v250 = p249.Position - u247
            local v251 = UDim2.new(u248.X.Scale, u248.X.Offset + v250.X, u248.Y.Scale, u248.Y.Offset + v250.Y)

            game:GetService('TweenService'):Create(_Parent, TweenInfo.new(u246), {Position = v251}):Play()
        end

        _Parent.InputBegan:Connect(function(p253)
            if p253.UserInputType == Enum.UserInputType.MouseButton1 or p253.UserInputType == Enum.UserInputType.Touch then
                u245 = true
                u247 = p253.Position
                u248 = _Parent.Position

                p253.Changed:Connect(function()
                    if p253.UserInputState == Enum.UserInputState.End then
                        u245 = false
                    end
                end)
            end
        end)
        _UserInputService.InputChanged:Connect(function(p254)
            if (p254.UserInputType == Enum.UserInputType.MouseMovement or p254.UserInputType == Enum.UserInputType.Touch) and u245 then
                u252(p254)
            end
        end)
        _LocalScript2.Parent.MouseButton1Click:Connect(function()
    ...
    v3.Main:AddParagraph({
        Title = 'creators',
        Content = 'By MagoScriptss',
    })
    v3.Main:AddButton({
        Title = 'Join Discord',
        Description = '',
        Callback = function()
            setclipboard('https://discord.gg/gM9cfjNS8U')
        end,
    })
    v3.Main:AddParagraph({
        Title = 'Farming ',
    ...
    _DropdownSelectWeapon:OnChanged(function(p260)
        ChooseWeapon = p260
    end)
    task.spawn(function()
        while wait() do
            pcall(function()
                if ChooseWeapon ~= 'Melee' then
                    if ChooseWeapon ~= 'Sword' then
                        if ChooseWeapon ~= ' Blox Fruit' then
                            ...
                            while true do
                                ...
                                if v264.ToolTip == 'Melee' and game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v264.Name)) then
                            ...
                            while true do
                                ...
                                if v268.ToolTip == 'Blox Fruit' and game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v268.Name)) then
                        ...
                        while true do
                            ...
                            if v272.ToolTip == 'Sword' and game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v272.Name)) then
                                SelectWeapon = v272.Name
                            end
                        end
                    end
                else
                    local v273, v274, v275 = pairs(game.Players.LocalPlayer.Backpack:GetChildren())
                    ...
                    while true do
                        ...
                        if v276.ToolTip == 'Melee' and game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v276.Name)) then
                            SelectWeapon = v276.Name
                        end
                    end
                end
            end)
                    ...
                    if string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) and game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible ~= false then
                        if string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) or game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                            ...
                            while true do
                                ...
                                if v281:FindFirstChild('Humanoid') and (v281:FindFirstChild('HumanoidRootPart') and (v281.Humanoid.Health > 0 and v281.Name == Ms)) then
                                    repeat
                                        game:GetService('RunService').Heartbeat:wait()
                                        AutoHaki()
                                        EquipTool(SelectWeapon)
                                        Tween(v281.HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))

                                        v281.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                        v281.HumanoidRootPart.Transparency = 1
                                        v281.Humanoid.JumpPower = 0
                                        v281.Humanoid.WalkSpeed = 0
                                        v281.HumanoidRootPart.CanCollide = false
                                        FarmPos = v281.HumanoidRootPart.CFrame
                                        MonFarm = v281.Name

                                        Click()
                                    until not AutoFarmQuest or (not v281.Parent or v281.Humanoid.Health <= 0) or (not game:GetService('Workspace').Enemies:FindFirstChild(v281.Name) or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false)
                                end
                            end

                            local v282, v283, v284 = pairs(game:GetService('Workspace')._WorldOrigin.EnemySpawns:GetChildren())
                            ...
                            while true do
                                ...
                                if string.find(v285.Name, NameMon) and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v285.Position).Magnitude >= 10 then
                                    Tween(v285.CFrame * CFrame.new(u256, u257, u258))
                                end
                            end
                        end
                    else
    ...
    spawn(function()
        while wait(0.1) do
            if AutoFarmNearestMob then
                pcall(function()
                    local v287, v288, v289 = pairs(game.Workspace.Enemies:GetChildren())
                    ...
                    while true do
                        ...
                        if v290:FindFirstChild('Humanoid') and (v290:FindFirstChild('HumanoidRootPart') and (v290.Humanoid.Health > 0 and (v290.Name and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v290:FindFirstChild('HumanoidRootPart').Position).Magnitude <= 5000))) then
                            repeat
                                task.wait(0.1)
                                AutoHaki()
                                EquipTool(SelectWeapon)
                                Tween(v290.HumanoidRootPart.CFrame * Pos)

                                v290.HumanoidRootPart.Size = Vector3.new(1, 1, 1)
                                v290.HumanoidRootPart.Transparency = 1
                                v290.Humanoid.JumpPower = 0
                                v290.Humanoid.WalkSpeed = 0
                                v290.HumanoidRootPart.CanCollide = false
                                FarmPos = v290.HumanoidRootPart.CFrame
                                MonFarm = v290.Name

                                Click()
                            until not AutoFarmNearestMob or (not v290.Parent or v290.Humanoid.Health <= 0) or not game.Workspace.Enemies:FindFirstChild(v290.Name)
                        end
                    end
                end)
            end
    ...
    function UseCode(p291)
        game:GetService('ReplicatedStorage').Remotes.Redeem:InvokeServer(p291)
    end
    ...
    function FPSBooster()
        local v292 = game
        local _Workspace = v292.Workspace
        local _Lighting = v292.Lighting
        ...
        local v296, v297, v298 = pairs(v292:GetDescendants())
        local v299 = true
        ...
        while true do
            ...
            if v300:IsA('Part') or (v300:IsA('Union') or (v300:IsA('CornerWedgePart') or v300:IsA('TrussPart'))) then
                v300.Material = 'Plastic'
                v300.Reflectance = 0
            elseif v300:IsA('Decal') or v300:IsA('Texture') and v299 then
                v300.Transparency = 1
            elseif v300:IsA('ParticleEmitter') or v300:IsA('Trail') then
                v300.Lifetime = NumberRange.new(0)
            elseif v300:IsA('Explosion') then
                v300.BlastPressure = 1
                v300.BlastRadius = 1
            elseif v300:IsA('Fire') or (v300:IsA('SpotLight') or (v300:IsA('Smoke') or v300:IsA('Sparkles'))) then
                v300.Enabled = false
            elseif v300:IsA('MeshPart') then
                v300.Material = 'Plastic'
                v300.Reflectance = 0
                v300.TextureID = 1.0385902758728955e16
            end
        end

        local v301, v302, v303 = pairs(_Lighting:GetChildren())
        ...
        while true do
            ...
            if v304:IsA('BlurEffect') or (v304:IsA('SunRaysEffect') or (v304:IsA('ColorCorrectionEffect') or (v304:IsA('BloomEffect') or v304:IsA('DepthOfFieldEffect')))) then
                v304.Enabled = false
            end
        end
    end
    ...
    _DropdownMastery:OnChanged(function(p306)
        TypeMastery = p306
    end)
    ...
    _SliderHealt:OnChanged(function(p311)
        KillPercent = p311
    end)
        ...
        while task.wait(0.1) do
            if AutoFarmMasGun and TypeMastery == 'Level' then
                pcall(function()
                    ...
                    local v312, v313, v314 = pairs(game:GetService('Workspace').Enemies:GetChildren())
                    ...
                    while true do
                        ...
                        if v315:FindFirstChild('Humanoid') and (v315:FindFirstChild('HumanoidRootPart') and v315.Name == Ms) then
                            if true then
                                game:GetService('RunService').Heartbeat:wait()
                                ...
                                if v315.Humanoid.Health > v315.Humanoid.MaxHealth * KillPercent / 100 then
                                    ...
                                    EquipTool(SelectWeapon)
                                    Click()
                                    Tween(v315.HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                            ...
                            if AutoFarmMasGun and (v315.Parent and v315.Humanoid.Health > 0) and (game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible ~= false and (game:GetService('Workspace').Enemies:FindFirstChild(v315.Name) and not TypeMastery ~= 'Queat')) then
                            end
            ...
            elseif AutoFarmMasGun and TypeMastery == 'No Quest' then
                pcall(function()
                    ...
                    if v319.Name ~= Ms or not (v319:FindFirstChild('Humanoid') and v319:FindFirstChild('HumanoidRootPart')) then
                    else
                    end
                    if true then
                        game:GetService('RunService').Heartbeat:wait()
                        ...
                        if v319.Humanoid.Health > v319.Humanoid.MaxHealth * KillPercent / 100 then
                            ...
                            AutoHaki()
                            EquipTool(SelectWeapon)
                            Tween(v319.HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                    ...
                    if AutoFarmMasGun and (v319.Parent and v319.Humanoid.Health > 0) and (game:GetService('Workspace').Enemies:FindFirstChild(v319.Name) and not TypeMastery ~= 'No Quest') then
                    end
                end)
            elseif AutoFarmMasGun and TypeMastery == 'Near Mobs' then
                pcall(function()
                    local v320, v321, v322 = pairs(game.Workspace.Enemies:GetChildren())
                    ...
                    while true do
                        ...
                        if v323.Name and (v323:FindFirstChild('Humanoid') and (v323:FindFirstChild('HumanoidRootPart') and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v323:FindFirstChild('HumanoidRootPart').Position).Magnitude <= 2000)) then
                            repeat
                                if true then
                                    game:GetService('RunService').Heartbeat:wait()
                                    ...
                                    if v323.Humanoid.Health > v323.Humanoid.MaxHealth * KillPercent / 100 then
                                        ...
                                        AutoHaki()
                                        EquipTool(SelectWeapon)
                                        Tween(v323.HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                                        ...
                                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v323.HumanoidRootPart.CFrame * Pos
                                        game:GetService('Players').LocalPlayer.Character[CurrentEquipGun].Cooldown.Value = 0
                                        UseSkillGun = true
                                    end
                                end
                            until not AutoFarmMasGun or (not MasteryType == 'Near Mobs' or (not v323.Parent or (v323.Humanoid.Health <= 0 or not TypeMastery == 'Near Mobs')))
                    ...
                    if game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                        pcall(function()
                            ...
                            if not game:GetService('Workspace').Enemies:FindFirstChild(SelectBoss) then
                                ...
                                Tween(game:GetService('ReplicatedStorage'):FindFirstChild(SelectBoss).HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                            ...
                            if true then
                                ...
                                if v327.Humanoid.Health > v327.Humanoid.MaxHealth * KillPercent / 100 then
                                    UseSkillGun = false

                                    AutoHaki()
                                    EquipTool(SelectWeapon)
                                    Tween(v327.HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))

                                    v327.HumanoidRootPart.Size = Vector3.new(1, 1, 1)
                                    v327.HumanoidRootPart.Transparency = 1
                                    v327.Humanoid.JumpPower = 0
                                    v327.Humanoid.WalkSpeed = 0
                                    v327.HumanoidRootPart.CanCollide = false
                                    FarmPos = v327.HumanoidRootPart.CFrame
                                    MonFarm = v327.Name
                                else
                                    EquipTool(CurrentEquipGun)
                                    Tween(v327.HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                            ...
                            if AutoFarmMasGun and (not TypeMastery ~= 'Boss' and (v327.Parent and (v327.Humanoid.Health > 0 and game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible ~= false))) and game:GetService('Workspace').Enemies:FindFirstChild(v327.Name) then
                            end
                            ...
                            if v327.Name ~= selectBoss or not (v327:FindFirstChild('Humanoid') and v327:FindFirstChild('HumanoidRootPart')) then
                            else
                            end
                        end)
                    end
            ...
            if UseSkillGun then
                pcall(function()
                    ...
                    while true do
                        ...
                        if v331.Name == MonFarm then
                            game:GetService('Players').LocalPlayer.Character[CurrentEquipGun].RemoteFunctionShoot:InvokeServer(v331.HumanoidRootPart.Position, v331.HumanoidRootPart)
                            ClickCamera()
                        end
                    end
                end)
                ...
                pcall(function()
                    ...
                    while true do
                        ...
                        if SkillZ then
                            ...
                            game:GetService('Players').LocalPlayer.Character[game:GetService('Players').LocalPlayer.Character:FindFirstChildOfClass('Tool').Name].RemoteEvent:FireServer(unpack(v336))
                        ...
                        if SkillX then
                            ...
                            game:GetService('Players').LocalPlayer.Character[game:GetService('Players').LocalPlayer.Character:FindFirstChildOfClass('Tool').Name].RemoteEvent:FireServer(unpack(v337))
        ...
        pcall(function()
            game:GetService('RunService').RenderStepped:Connect(function()
                if UseSkillGun then
                    ...
                    game:GetService('Players').LocalPlayer.Character[game:GetService('Players').LocalPlayer.Data.Gun.Value].RemoteEvent:FireServer(unpack(v338))
                end
            end)
        end)
    end)
        ...
        while task.wait(1) do
            if _G.UseSkill then
                pcall(function()
                    ...
                    local v339, v340, v341 = pairs(game:GetService('Workspace').Enemies:GetChildren())
                    local v342
                    ...
                    if v342.Name ~= MonFarm or (not v342:FindFirstChild('Humanoid') or (not v342:FindFirstChild('HumanoidRootPart') or v342.Humanoid.Health > v342.Humanoid.MaxHealth * KillPercent / 100)) then
                    end

                    game:GetService('RunService').Heartbeat:wait()
                    EquipTool(game.Players.LocalPlayer.Data.DevilFruit.Value)
                    Tween(v342.HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))

                    PositionSkillMasteryDevilFruit = v342.HumanoidRootPart.Position
                    ...
                    if AutoFarmMasDevilFruit and (_G.UseSkill and v342.Humanoid.Health ~= 0) then
                    else
                    end
                end)
            end
        ...
        while task.wait(0.1) do
            if AutoFarmMasDevilFruit and TypeMastery == 'Level' then
                pcall(function()
                    ...
                    local v344, v345, v346 = pairs(game:GetService('Workspace').Enemies:GetChildren())
                    ...
                    while true do
                        ...
                        if v347:FindFirstChild('Humanoid') and (v347:FindFirstChild('HumanoidRootPart') and v347.Name == Ms) then
                            if true then
                                game:GetService('RunService').Heartbeat:wait()
                                ...
                                if v347.Humanoid.Health > v347.Humanoid.MaxHealth * KillPercent / 100 then
                                    ...
                                    EquipTool(SelectWeapon)
                                    Click()
                                    Tween(v347.HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                            ...
                            if AutoFarmMasDevilFruit and (v347.Parent and v347.Humanoid.Health ~= 0) and (game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible ~= false and (game:GetService('Workspace').Enemies:FindFirstChild(v347.Name) and not TypeMastery ~= 'Level')) then
                            end
                ...
                pcall(function()
                    ...
                    if true then
                        ...
                        if v351.Humanoid.Health > v351.Humanoid.MaxHealth * KillPercent / 100 then
                            ...
                            AutoHaki()
                            EquipTool(SelectWeapon)
                            Tween(v351.HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                    ...
                    if AutoFarmMasDevilFruit and (v351.Parent and v351.Humanoid.Health ~= 0) and (game:GetService('Workspace').Enemies:FindFirstChild(v351.Name) and not TypeMastery ~= 'No Quest') then
                    else
                    end
                    ...
                    if v351.Name ~= Ms or not (v351:FindFirstChild('Humanoid') and v351:FindFirstChild('HumanoidRootPart')) then
                    else
                    end
                end)
            elseif AutoFarmMasDevilFruit and TypeMastery == 'Near Mobs' then
                pcall(function()
                    local v352, v353, v354 = pairs(game.Workspace.Enemies:GetChildren())
                    ...
                    while true do
                        ...
                        if v355.Name and (v355:FindFirstChild('Humanoid') and (v355:FindFirstChild('HumanoidRootPart') and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v355:FindFirstChild('HumanoidRootPart').Position).Magnitude <= 2000)) then
                            repeat
                                if true then
                                    game:GetService('RunService').Heartbeat:wait()
                                    ...
                                    if v355.Humanoid.Health > v355.Humanoid.MaxHealth * KillPercent / 100 then
                                        ...
                                        AutoHaki()
                                        EquipTool(SelectWeapon)
                                        Tween(v355.HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                            ...
                            until not AutoFarmMasDevilFruit or (not MasteryType == 'Nearest' or (not v355.Parent or (v355.Humanoid.Health == 0 or not TypeMastery == 'Nearest')))
                ...
                if game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible ~= false then
                    if game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                        pcall(function()
                            ...
                            local v356, v357, v358 = pairs(game:GetService('Workspace').Enemies:GetChildren())

                            if true then
                                game:GetService('RunService').Heartbeat:wait()

                                if v359.Humanoid.Health > v359.Humanoid.MaxHealth * KillPercent / 100 then
                                    _G.UseSkill = false

                                    AutoHaki()
                                    EquipTool(SelectWeapon)
                                    Tween(v359.HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))

                                    v359.HumanoidRootPart.Size = Vector3.new(1, 1, 1)
                                    v359.HumanoidRootPart.Transparency = 1
                                    v359.Humanoid.JumpPower = 0
                                    v359.Humanoid.WalkSpeed = 0
                                    v359.HumanoidRootPart.CanCollide = false
                                    FarmPos = v359.HumanoidRootPart.CFrame
                                    MonFarm = v359.Name
                                else
                                    _G.UseSkill = true
                                end
                            end
                            if AutoFarmMasDevilFruit and (not TypeMastery ~= 'Boss' and (v359.Parent and (v359.Humanoid.Health ~= 0 and game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible ~= false))) and game:GetService('Workspace').Enemies:FindFirstChild(v359.Name) then
                            end
                            ...
                            if v359.Name ~= selectBoss or not (v359:FindFirstChild('Humanoid') and v359:FindFirstChild('HumanoidRootPart')) then
                            else
                            end
                        end)
                    end
    ...
    local u361 = CFrame.new(-9515.75, 174.8521728515625, 6079.40625)
                ...
                pcall(function()
                    ...
                    if game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                        if BypassTP then
                            ...
                            if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u361.Position).Magnitude <= 2500 then
                                if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u361.Position).Magnitude < 2500 then
                                    Tween(u361)
                                end
                            else
                        ...
                        if (u361.Position - game:GetService('Players').LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 then
                    ...
                    if game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                        if game:GetService('Workspace').Enemies:FindFirstChild('Reborn Skeleton') or (game:GetService('Workspace').Enemies:FindFirstChild('Living Zombie') or (game:GetService('Workspace').Enemies:FindFirstChild('Demonic Soul') or game:GetService('Workspace').Enemies:FindFirstChild('Posessed Mummy'))) then
                            ...
                            while true do
                                ...
                                if v366:FindFirstChild('HumanoidRootPart') and (v366:FindFirstChild('Humanoid') and (v366.Humanoid.Health > 0 and (v366.Name == 'Reborn Skeleton' or (v366.Name == 'Living Zombie' or (v366.Name == 'Demonic Soul' or v366.Name == 'Posessed Mummy'))))) then
                                    if string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Demonic Soul') then
                                        ...
                                        v366.HumanoidRootPart.Size = Vector3.new(1, 1, 1)
                                        ...
                                        if AutoFarmBone and (v366.Humanoid.Health > 0 and v366.Parent) and game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible ~= false then
                                        end
                                    else
                                        game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('AbandonQuest')
                                    end
            ...
            if AutoCakePrince then
                ...
                if game.ReplicatedStorage:FindFirstChild('Cake Prince') or game:GetService('Workspace').Enemies:FindFirstChild('Cake Prince') then
                    if game:GetService('Workspace').Enemies:FindFirstChild('Cake Prince') then
                        ...
                        while true do
                            ...
                            if AutoCakePrince and (v371.Name == 'Cake Prince' and (v371:FindFirstChild('HumanoidRootPart') and (v371:FindFirstChild('Humanoid') and v371.Humanoid.Health > 0))) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipTool(SelectWeapon)
                                ...
                                until not AutoCakePrince or (not v371.Parent or v371.Humanoid.Health <= 0)
                            end
                        end
                ...
                elseif game:GetService('Workspace').Enemies:FindFirstChild('Cookie Crafter') or (game:GetService('Workspace').Enemies:FindFirstChild('Cake Guard') or (game:GetService('Workspace').Enemies:FindFirstChild('Baking Staff') or game:GetService('Workspace').Enemies:FindFirstChild('Head Baker'))) then
                    ...
                    while true do
                        ...
                        if v375:FindFirstChild('Humanoid') and (v375:FindFirstChild('HumanoidRootPart') and (v375.Humanoid.Health > 0 and (v375.Name == 'Cookie Crafter' or (v375.Name == 'Cake Guard' or (v375.Name == 'Baking Staff' or v375.Name == 'Head Baker'))))) and (v375:FindFirstChild('HumanoidRootPart') and (v375:FindFirstChild('Humanoid') and v375.Humanoid.Health > 0)) then
                            repeat
                                task.wait()
                                AutoHaki()
                                EquipTool(SelectWeapon)
                                ...
                                game:GetService('VirtualUser'):CaptureController()
                                game:GetService('VirtualUser'):Button1Down(Vector2.new(1280, 672), workspace.CurrentCamera.CFrame)
                            until not AutoCakePrince or (not v375.Parent or v375.Humanoid.Health <= 0)
                        end
                    end
                else
                    local v376 = CFrame.new(-2077, 252, -12373)

                    if BypassTP then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v376.Position).Magnitude <= 2000 then
                            if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v376.Position).Magnitude < 2000 then
                                Tween(v376)
                            end
                        else
    ...
    _DropdownMaterial:OnChanged(function(p378)
        SelectMaterial = p378
    end)
            ...
            if AutoFarmMaterial then
                pcall(function()
                    ...
                    if game:GetService('Workspace').Enemies:FindFirstChild(MMon) then
                        local v380, v381, v382 = pairs(game.Workspace.Enemies:GetChildren())
                        ...
                        while true do
                            ...
                            if v383:FindFirstChild('Humanoid') and (v383:FindFirstChild('HumanoidRootPart') and (v383.Humanoid.Health > 0 and v383.Name == MMon)) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipTool(SelectWeapon)
                                    Tween(v383.HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))

                                    v383.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                    v383.HumanoidRootPart.Transparency = 1
                                    v383.Humanoid.JumpPower = 0
                                    v383.Humanoid.WalkSpeed = 0
                                    v383.HumanoidRootPart.CanCollide = false
                                    FarmPos = v383.HumanoidRootPart.CFrame
                                    MonFarm = v383.Name

                                    Click()
                                until not AutoFarmMaterial or (not v383.Parent or v383.Humanoid.Health <= 0)
                            end
                        end
                    else
                        local v384, v385, v386 = pairs(game:GetService('Workspace')._WorldOrigin.EnemySpawns:GetChildren())
                        ...
                        while true do
                            ...
                            if string.find(v387.Name, Mon) and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v387.Position).Magnitude >= 10 then
                                Tween(v387.CFrame * CFrame.new(u256, u257, u258))
                            end
                        end
                    end
                end)
        ...
        spawn(function()
            while wait() do
                pcall(function()
                    ...
                    local v389, v390, v391 = pairs(game:GetService('Workspace').Boats:GetChildren())
                    local v392
                    ...
                    if v392.Name ~= 'PirateGrandBrigade' then
                    else
                    end
                    if true then
                        wait()
                ...
                if _G.AutoTerrorshark then
                    pcall(function()
                        if game:GetService('Workspace').Enemies:FindFirstChild('Terrorshark') then
                            local v395, v396, v397 = pairs(game:GetService('Workspace').Enemies:GetChildren())
                            ...
                            while true do
                                ...
                                if v398.Name == 'Terrorshark' and (v398:FindFirstChild('Humanoid') and (v398:FindFirstChild('HumanoidRootPart') and v398.Humanoid.Health > 0)) then
                                    repeat
                                        task.wait()
                                        AutoHaki()
                                        EquipTool(SelectWeapon)
                                        ...
                                        v398.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                                        Click()
                                        Tween(v398.HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                                    until not _G.AutoTerrorshark or (not v398.Parent or v398.Humanoid.Health <= 0)
                                end
                            end
                    ...
                    pcall(function()
                        if game:GetService('Workspace').Enemies:FindFirstChild('Piranha') then
                            ...
                            while true do
                                ...
                                if v403.Name == 'Piranha' and (v403:FindFirstChild('Humanoid') and (v403:FindFirstChild('HumanoidRootPart') and v403.Humanoid.Health > 0)) then
                                    repeat
                                        task.wait()
                                        AutoHaki()
                                        EquipTool(SelectWeapon)
                                        ...
                                        v403.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                                        Click()
                                        Tween(v403.HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                                    until not _G.farmpiranya or (not v403.Parent or v403.Humanoid.Health <= 0)
                                end
                            end
                        ...
                        elseif string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Diablo') or (string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Deandre') or string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Urban')) then
                            if game:GetService('Workspace').Enemies:FindFirstChild('Diablo') or (game:GetService('Workspace').Enemies:FindFirstChild('Deandre') or game:GetService('Workspace').Enemies:FindFirstChild('Urban')) then
                                ...
                                while true do
                                    ...
                                    if v408:FindFirstChild('Humanoid') and (v408:FindFirstChild('HumanoidRootPart') and v408.Humanoid.Health > 0) then
                                        if v408.Name == 'Diablo' or (v408.Name == 'Deandre' or v408.Name == 'Urban') then
                                            repeat
                                                task.wait()
                                                EquipTool(SelectWeapon)
                                                AutoHaki()
                                                ...
                                                MonsterPosition = v408.HumanoidRootPart.CFrame
                                                v408.HumanoidRootPart.CFrame = v408.HumanoidRootPart.CFrame
                                                ...
                                                MonFarm = v408.Name
                                                v408.HumanoidRootPart.Size = Vector3.new(1, 1, 1)
                                                BringMobs = false
                                            until AutoEliteHunter == false or (v408.Humanoid.Health <= 0 or not v408.Parent)
                                        end
                            ...
                            elseif BypassTP then
                                if game:GetService('ReplicatedStorage'):FindFirstChild('Diablo') then
                                    BTP(game:GetService('ReplicatedStorage'):FindFirstChild('Diablo').HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                                elseif game:GetService('ReplicatedStorage'):FindFirstChild('Deandre') then
                                    BTP(game:GetService('ReplicatedStorage'):FindFirstChild('Deandre').HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                                elseif game:GetService('ReplicatedStorage'):FindFirstChild('Urban') then
                                    BTP(game:GetService('ReplicatedStorage'):FindFirstChild('Urban').HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                                end
                            elseif game:GetService('ReplicatedStorage'):FindFirstChild('Diablo') then
                                Tween(game:GetService('ReplicatedStorage'):FindFirstChild('Diablo').HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                            elseif game:GetService('ReplicatedStorage'):FindFirstChild('Deandre') then
                                Tween(game:GetService('ReplicatedStorage'):FindFirstChild('Deandre').HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                            elseif game:GetService('ReplicatedStorage'):FindFirstChild('Urban') then
                                Tween(game:GetService('ReplicatedStorage'):FindFirstChild('Urban').HumanoidRootPart.CFrame * CFrame.new(u256, u257, u258))
                            end
                        end
                    end)
                end
    ...
    if Third_Sea then
        ...
        v3.Main:AddToggle('ToggleSeaBeAst', {
            ...
            _G.Auto_Seabest = p409
        end)
        _Options.ToggleSeaBeAst:SetValue(false)

        local v410 = getrawmetatable(game)
        local ___namecall2 = v410.__namecall

        setreadonly(v410, false)

        v410.__namecall = newcclosure(function(...)
            local v412 = getnamecallmethod()
            local v413 = {...}

            if tostring(v412) ~= 'FireServer' or (tostring(v413[1]) ~= 'RemoteEvent' or (tostring(v413[2]) == 'true' or (tostring(v413[2]) == 'false' or not Skillaimbot))) then
                return ___namecall2(...)
            end

            v413[2] = AimBotSkillPosition

            return ___namecall2(unpack(v413))
        end)
        Skillz = true
        Skillx = true
        Skillc = true
                ...
                pcall(function()
                    if _G.Auto_Seabest then
                        if game:GetService('Workspace').SeaBeasts:FindFirstChild('SeaBeast1') then
                            if game:GetService('Workspace').SeaBeasts:FindFirstChild('SeaBeast1') then
                                local v414, v415, v416 = pairs(game:GetService('Workspace').SeaBeasts:GetChildren())
                                ...
                                while true do
                                    ...
                                    if v417:FindFirstChild('HumanoidRootPart') then
                                        repeat
                                            wait()

                                            game.Players.LocalPlayer.Character:WaitForChild('Humanoid').Sit = false

                                            TPP(v417.HumanoidRootPart.CFrame * CFrame.new(0, 500, 0))
                                            EquipAllWeapon()

                                            AutoSkill = true
                                            AimBotSkillPosition = v417.HumanoidRootPart
                                            Skillaimbot = true
                                        until not v417:FindFirstChild('HumanoidRootPart') or _G.Auto_Seabest == false
                        ...
                        elseif game:GetService('Workspace').Boats:FindFirstChild('PirateBrigade') then
                            if game:GetService('Workspace').Boats:FindFirstChild('PirateBrigade') then
                                local v418, v419, v420 = pairs(game:GetService('Workspace').Boats:GetChildren())
                                ...
                                while true do
                                    ...
                                    if v421.Name == 'PirateBrigade' and v421:FindFirstChild('VehicleSeat') then
                                        repeat
                                            wait()

                                            game.Players.LocalPlayer.Character:WaitForChild('Humanoid').Sit = false

                                            TPP(v421.VehicleSeat.CFrame * CFrame.new(0, 1, 0))
                            ...
                            if game:GetService('Workspace').Boats:FindFirstChild('PirateBrigade') then
                                local v422, v423, v424 = pairs(game:GetService('Workspace').Boats:GetChildren())
                                ...
                                while true do
                                    ...
                                    if v425.Name == 'PirateBrigade' and v425:FindFirstChild('VehicleSeat') then
                                        repeat
                                            wait()

                                            game.Players.LocalPlayer.Character:WaitForChild('Humanoid').Sit = false

                                            TPP(v425.VehicleSeat.CFrame * CFrame.new(0, 1, 0))
                                        until not game:GetService('Workspace').Boats:FindFirstChild('PirateBrigade') or _G.Auto_Seabest == false
                                    end
                                end
                            end
        ...
        v3.Main:AddToggle('ToggleMirage', {
            ...
            if _G.dao then
                ...
                game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(v427))
                wait(1)
                ...
                function two(p428)
                    ...
                    if (game:GetService('Players').LocalPlayer.Character.HumanoidRootPart.Position - p428.Position).Magnitude > 200 then
                        local _TweenService4 = game:service('TweenService')
                        local u430 = TweenInfo.new((game:GetService('Players').LocalPlayer.Character.HumanoidRootPart.Position - p428.Position).Magnitude / 325, Enum.EasingStyle.Linear)
                        local v432, v433 = pcall(function()
                            local v431 = {CFrame = p428}

                            tweenz = _TweenService4:Create(game.Players.LocalPlayer.Character.HumanoidRootPart, u430, v431)
                        ...
                        game:GetService('Players').LocalPlayer.Character.HumanoidRootPart.CFrame = p428
                    end
                ...
                local v434 = next
                local v435, v436 = workspace.Boats.PirateBrigade:GetDescendants()
                ...
                while true do
                    ...
                    if v437.Name:find('VehicleSeat') then
                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v437.CFrame
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Soul Reaper') then
                        ...
                        while true do
                            ...
                            if string.find(v443.Name, 'Soul Reaper') then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipTool(SelectWeapon)

                                    v443.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                                    Tween(v443.HumanoidRootPart.CFrame * Pos)

                                    v443.HumanoidRootPart.Transparency = 1

                                    sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                                    Click()
                                until v443.Humanoid.Health <= 0 or AutoHallowSycthe == false
                            end
                        end
    ...
    local u446 = CFrame.new(-10238.875976563, 389.7912902832, -9549.7939453125)
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Longma') then
                        ...
                        while true do
                            ...
                            if v450.Name == 'Longma' and (v450:FindFirstChild('Humanoid') and (v450:FindFirstChild('HumanoidRootPart') and v450.Humanoid.Health > 0)) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipTool(SelectWeapon)
                                    ...
                                    v450.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                                    Tween(v450.HumanoidRootPart.CFrame * Pos)
                                    Click()
                                    sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                                until not _G.Autotushita or (not v450.Parent or v450.Humanoid.Health <= 0)
                            end
                        end
                    else
                        if BypassTP then
                            if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u446.Position).Magnitude <= 1500 then
                                if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u446.Position).Magnitude < 1500 then
                                    Tween(u446)
                                end
                            else
    ...
    local u454 = require(_LocalPlayer.PlayerScripts.CombatFramework.Particle)
    local u455 = require(game:GetService('ReplicatedStorage').CombatFramework.RigLib)

    spawn(function()
        while task.wait() do
            pcall(function()
                if not shared.orl then
                    shared.orl = u455.wrapAttackAnimationAsync
                end
                if not shared.cpc then
                    shared.cpc = u454.play
                end

                function u455.wrapAttackAnimationAsync(p456, p457, p458, p459, p460)
                    local v461 = u455.getBladeHits(p457, p458, p459)

                    if v461 then
                        if FastAttack then
                            function u454.play() end

                            p456:Play(0.01, 0.01, 0.01)
                            p460(v461)

                            u454.play = shared.cpc

                            wait(p456.length * 0.5)
                            p456:Stop()
                        else
                            p456:Play()
                        end
    ...
    function GetBladeHit()
        local v462 = debug.getupvalues(require(game:GetService('Players').LocalPlayer.PlayerScripts.CombatFramework))[2].activeController.blades[1]

        if not v462 then
            return v462
        end

        while v462.Parent ~= game.Players.LocalPlayer.Character do
            v462 = v462.Parent
        end
    ...
    function AttackHit()
        local u463 = debug.getupvalues(require(game:GetService('Players').LocalPlayer.PlayerScripts.CombatFramework))[2]
        local _LocalPlayer2 = game.Players.LocalPlayer

        for v465 = 1, 1 do
            local v466 = require(game.ReplicatedStorage.CombatFramework.RigLib).getBladeHits(_LocalPlayer2.Character, {
                _LocalPlayer2.Character.HumanoidRootPart,
            }, 60)
            ...
            while true do
                ...
                v469, v473 = v467(v468, v469)

                if v469 == nil then
                    break
                end
                if v473.Parent:FindFirstChild('HumanoidRootPart') and not v471[v473.Parent] then
                    table.insert(u472, v473.Parent.HumanoidRootPart)

                    v471[v473.Parent] = true
                end
            end

            if #u472 > 0 then
                pcall(function()
                    u463.activeController.timeToNextAttack = 1
                    u463.activeController.attacking = false
                    u463.activeController.blocking = false
                    u463.activeController.timeToNextBlock = 0
                    u463.activeController.increment = 3
                    u463.activeController.hitboxMagnitude = 60
                    u463.activeController.focusStart = 0

                    game:GetService('ReplicatedStorage').RigControllerEvent:FireServer('weaponChange', tostring(GetBladeHit()))
                    game:GetService('ReplicatedStorage').RigControllerEvent:FireServer('hit', u472, u470, '')
                end)
            end
        end
    end
            ...
            if BringMobs then
                pcall(function()
                    ...
                    while true do
                        ...
                        if not string.find(v478.Name, 'Boss') and (v478.Name == MonFarm and ((v478.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350 and (InMyNetWork(v478.HumanoidRootPart) and InMyNetWork(v478.HumanoidRootPart)))) then
                            v478.HumanoidRootPart.CFrame = FarmPos
                            v478.HumanoidRootPart.CanCollide = false
                            v478.HumanoidRootPart.Size = Vector3.new(1, 1, 1)
                        end
                    end
                end)
            end
    ...
    function InMyNetWork(p479)
        if isnetworkowner then
            return isnetworkowner(p479)
        else
            return (p479.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350
        end
    end
    ...
    v3.Stats:AddToggle('ToggleFruit', {
        ...
        _G.Auto_Stats_Devil_Fruit = p491
    end)
    ...
    local v492, v493, v494 = pairs(game:GetService('Players'):GetChildren())
    local u495 = {}
    ...
    local v498 = _SelectedPly

    _SelectedPly.SetValue(v498, 'nil')

    local v499 = _SelectedPly

    _SelectedPly.OnChanged(v499, function(p500)
        _G.SelectPly = p500
    end)
    v3.Player:AddButton({
        ...
        Callback = function()
            ...
            local v501, v502, v503 = pairs(game:GetService('Players'):GetChildren())
    ...
    _DropdownIsland:OnChanged(function(p508)
        _G.SelectIsland = p508
    end)
    v3.Teleport:AddToggle('ToggleIsland', {
        Title = 'Teleport',
        Default = false,
    }):OnChanged(function(p509)
        _G.TeleportIsland = p509
    ...
    function BTPZ(p510)
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p510
    ...
    while true do
        ...
        v513, v514 = v512(_GetFruits, v513)

        if v513 == nil then
            break
        end

        table.insert(Table_DevilFruitSniper, v514.Name)

        if v514.OnSale then
            table.insert(ShopDevilSell, v514.Name)
        end
    end
    ...
    _DropdownFruit:OnChanged(function(p516)
        _G.SelectFruit = p516
    end)
    ...
    spawn(function()
        while wait(0.1) do
            if _G.Tweenfruit then
                local v521, v522, v523 = pairs(game.Workspace:GetChildren())
                ...
                while true do
                    ...
                    if string.find(v524.Name, 'Fruit') then
                        TP2(v524.Handle.CFrame)
                    end
                end
            end
        end
    ...
    _DropdownRaid:OnChanged(function(p530)
        SelectChip = p530
    end)
    v3.Raid:AddToggle('ToggleBuy', {
        ...
        _G.Auto_Buy_Chips_Dungeon = p531
    end)
        ...
        while wait() do
            if _G.Auto_Buy_Chips_Dungeon then
                pcall(function()
                    ...
                    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack(v532))
                end)
            end
        end
    end)
    ...
    spawn(function()
        while wait() do
            if Killaura then
                local v535, v536, v537 = pairs(game.Workspace.Enemies:GetDescendants())

                while true do
                    local u538

                    v537, u538 = v535(v536, v537)

                    if v537 == nil then
                        break
                    end
                    if u538:FindFirstChild('Humanoid') and (u538:FindFirstChild('HumanoidRootPart') and u538.Humanoid.Health > 0) then
                        pcall(function()
                            repeat
                                wait(0.1)
                                sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)

                                u538.Humanoid.Health = 0
                                u538.HumanoidRootPart.CanCollide = false
                                u538.HumanoidRootPart.Size = Vector3.new(50, 50, 50)
                                u538.HumanoidRootPart.Transparency = 0.8
                            until not Killaura or (not u538.Parent or u538.Humanoid.Health <= 0)
                        end)
                    end
                end
            end
                    ...
                    if game:GetService('ReplicatedStorage'):FindFirstChild('Order') or game:GetService('Workspace').Enemies:FindFirstChild('Order') then
                        if game:GetService('Workspace').Enemies:FindFirstChild('Order') then
                            ...
                            while true do
                                ...
                                if v546.Name == 'Order' then
                                    repeat
                                        game:GetService('RunService').Heartbeat:wait()
                                        AutoHaki()
                                        EquipTool(SelectWeapon)
                                        Tween(v546.HumanoidRootPart.CFrame * Pos)

                                        v546.HumanoidRootPart.CanCollide = false
                                        v546.HumanoidRootPart.Size = Vector3.new(120, 120, 120)

                                        Click()
                                    until not v546.Parent or (v546.Humanoid.Health <= 0 or Auto_Law == false)
                                end
                            end
                        ...
                        if game:GetService('Players').LocalPlayer.Data.Race.Value ~= 'Skypiea' then
                            if game:GetService('Players').LocalPlayer.Data.Race.Value ~= 'Fishman' then
                                if game:GetService('Players').LocalPlayer.Data.Race.Value ~= 'Cyborg' then
                                    if game:GetService('Players').LocalPlayer.Data.Race.Value ~= 'Ghoul' then
                                        if game:GetService('Players').LocalPlayer.Data.Race.Value == 'Mink' then
                                            local v549, v550, v551 = pairs(game:GetService('Workspace'):GetDescendants())
                                            ...
                                            while true do
                                                ...
                                                if v552.Name == 'StartPoint' then
                                                    Tween(v552.CFrame * CFrame.new(0, 10, 0))
                                                end
                                            end
                                        end
                                    else
                                        local v553, v554, v555 = pairs(game.Workspace.Enemies:GetDescendants())

                                        while true do
                                            local u556

                                            v555, u556 = v553(v554, v555)

                                            if v555 == nil then
                                                break
                                            end
                                            if u556:FindFirstChild('Humanoid') and (u556:FindFirstChild('HumanoidRootPart') and u556.Humanoid.Health > 0) then
                                                pcall(function()
                                                    repeat
                                                        wait(0.1)

                                                        u556.Humanoid.Health = 0
                                                        u556.HumanoidRootPart.CanCollide = false

                                                        sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                                                    until not _G.AutoQuestRace or (not u556.Parent or u556.Humanoid.Health <= 0)
                                                end)
                                            end
                                        end
                                    end
                                ...
                                local v557, v558, v559 = pairs(game:GetService('Workspace').SeaBeasts.SeaBeast1:GetDescendants())
                                ...
                                while true do
                                    ...
                                    if v560.Name == 'HumanoidRootPart' then
                                        Tween(v560.CFrame * Pos)

                                        local v561, v562, v563 = pairs(game.Players.LocalPlayer.Backpack:GetChildren())
                                        ...
                                        while true do
                                            ...
                                            if v564:IsA('Tool') and v564.ToolTip == 'Melee' then
                                        ...
                                        local v565, v566, v567 = pairs(game.Players.LocalPlayer.Backpack:GetChildren())
                                        ...
                                        while true do
                                            ...
                                            if v568:IsA('Tool') and v568.ToolTip == 'Blox Fruit' then
                                                game.Players.LocalPlayer.Character.Humanoid:EquipTool(v568)
                                            end
                                        end
                                        ...
                                        local v569, v570, v571 = pairs(game.Players.LocalPlayer.Backpack:GetChildren())
                                        ...
                                        while true do
                                            ...
                                            if v572:IsA('Tool') and v572.ToolTip == 'Sword' then
                                                game.Players.LocalPlayer.Character.Humanoid:EquipTool(v572)
                                            end
                                        end
                                        ...
                                        local v573, v574, v575 = pairs(game.Players.LocalPlayer.Backpack:GetChildren())
                                        ...
                                        while true do
                                            ...
                                            if v576:IsA('Tool') and v576.ToolTip == 'Gun' then
                                                game.Players.LocalPlayer.Character.Humanoid:EquipTool(v576)
                                            end
                                        end
                            ...
                            local v577, v578, v579 = pairs(game:GetService('Workspace').Map.SkyTrial.Model:GetDescendants())
                            ...
                            while true do
                                ...
                                if v580.Name == 'snowisland_Cylinder.081' then
                                    Tween(v580.CFrame * CFrame.new(0, 0, 0))
                                end
                            end
                        end
                    else
                        local v581, v582, v583 = pairs(game.Workspace.Enemies:GetDescendants())

                        while true do
                            local u584

                            v583, u584 = v581(v582, v583)

                            if v583 == nil then
                                break
                            end
                            if u584:FindFirstChild('Humanoid') and (u584:FindFirstChild('HumanoidRootPart') and u584.Humanoid.Health > 0) then
                                pcall(function()
                                    repeat
                                        wait(0.1)

                                        u584.Humanoid.Health = 0
                                        u584.HumanoidRootPart.CanCollide = false

                                        sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                                    until not _G.AutoQuestRace or (not u584.Parent or u584.Humanoid.Health <= 0)
                                end)
                            end
                        end
                    end
    ...
    local u586 = CFrame.new(216.211181640625, 126.9352035522461, -12599.0732421875)
            ...
            if AutoFarmAcient then
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Cocoa Warrior') or (game:GetService('Workspace').Enemies:FindFirstChild('Chocolate Bar Battler') or (game:GetService('Workspace').Enemies:FindFirstChild('Sweet Thief') or game:GetService('Workspace').Enemies:FindFirstChild('Candy Rebel'))) then
                        local v587, v588, v589 = pairs(game:GetService('Workspace').Enemies:GetChildren())
                        ...
                        while true do
                            ...
                            if (v590.Name == 'Cocoa Warrior' or (v590.Name == 'Chocolate Bar Battler' or (v590.Name == 'Sweet Thief' or v590.Name == 'Candy Rebel'))) and (v590:FindFirstChild('Humanoid') and (v590:FindFirstChild('HumanoidRootPart') and v590.Humanoid.Health > 0)) then
                                repeat
                                    task.wait()
                                    AutoHaki()
                                    EquipTool(SelectWeapon)
                                    ...
                                    BringAcient = true
                                    v590.HumanoidRootPart.CanCollide = false
                                    v590.Humanoid.WalkSpeed = 0
                                    v590.Head.CanCollide = false
                                    FarmPos = v590.HumanoidRootPart.CFrame

                                    Tween(v590.HumanoidRootPart.CFrame * Pos)
                                    Click()
                                until not AutoFarmAcient or (not v590.Parent or v590.Humanoid.Health <= 0)
                        ...
                        local v591, v592, v593 = pairs(game:GetService('ReplicatedStorage'):GetChildren())
                        ...
                        while true do
                            ...
                            if v594.Name ~= 'Cocoa Warrior' then
                                if v594.Name ~= 'Chocolate Bar Battler' then
                                    if v594.Name ~= 'Sweet Thief' then
                                        if v594.Name == 'Candy Rebel' then
                                            Tween(v594.HumanoidRootPart.CFrame * CFrame.new(2, 20, 2))
                                        end
                                    else
                                        Tween(v594.HumanoidRootPart.CFrame * CFrame.new(2, 20, 2))
                                    end
